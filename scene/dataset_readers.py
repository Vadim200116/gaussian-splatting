...
def readColmapCameras(cam_extrinsics, cam_intrinsics, depths_params, images_folder, depths_folder, semantics_folder, test_cam_names_list):
    cam_infos = []
...
def readColmapSceneInfo(path, images, depths, eval, train_test_exp, load_semantics=False, llffhold=8):
    try:
